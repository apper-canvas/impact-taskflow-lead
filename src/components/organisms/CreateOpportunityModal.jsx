        ...
        <motion.div
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Opportunity Name <span className="text-red-500">*</span>
                        </label>
                        <Input
                            value={formData.Name}
                            onChange={e => handleChange("Name", e.target.value)}
                            placeholder="Enterprise Deal 2024"
                            disabled={loading}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Deal Size <span className="text-red-500">*</span>
                        </label>
                        <Input
                            type="number"
                        ...
                        {errors.deal_size_c && <p className="mt-1 text-sm text-red-600">{errors.deal_size_c}</p>}
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">Stage
                                                </label>
                            <Select
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">Probability: {formData.probability_c}%
                                                </label>
                            <input
                                type="range"
                                min="0"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Tags
                                          </label>
                        <Input
                            value={formData.Tags}
                    ...
                    <div
                        ...
                        <Button type="button" variant="outline" onClick={onClose} disabled={loading}>Cancel
                                          </Button>
                        <Button type="submit" variant="primary" disabled={loading}>
                            {loading ? <>
                                <ApperIcon name="Loader2" size={18} className="animate-spin" />Saving...
                                                  </> : <>
